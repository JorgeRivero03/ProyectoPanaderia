...
public class VerificarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //prmero tenemos que obtener los parametros del inicio de sesion 
            ...
            if (u != null) {
                //el usuario existe dentro de la base de datos
                //obtenemos su sesion
                ...
                //ahora verificamos el tpo de usuario si es admin o cliente
                if (u.getPriv_usu() == 0) {
                    //si es 0 es un cliente
