...
public class MVenta {
    ...
    //regitrar el detalle de la venta
    public boolean registrarVenta(MVenta v, Vector<DVenta> ldvp){
        ...
        try{
            ...
            //si se registro en la base de datos
    ...
    private boolean registrarDetalleVenta(int codigo, Vector<DVenta> ldvp, Connection con){
        ...
        PreparedStatement ps = null;
        try{
            //debo de recoorer todo el vector del detalle de la venta
            for (DVenta dv : ldvp) {
                String q = "insert into DVenta (id_pan, cant_dventa, subtotal_dventa, id_venta, id_venta, id_eusu) values (?, ?, ?, ?, ?)";
            ...
            System.out.println("No conecto al detalle de la venta ");
            System.out.println(e.getMessage());
            System.out.println(e.getStackTrace());
